...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    after_files = { "/Users/jackpordi/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    loaded = true,
    needs_bufread = false,
    path = "/Users/jackpordi/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
